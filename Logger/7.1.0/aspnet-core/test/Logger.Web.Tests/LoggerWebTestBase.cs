...
{
    public abstract class LoggerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LoggerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LoggerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LoggerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LoggerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LoggerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LoggerDbContext, Task<T>> func)
        {
            T result;
