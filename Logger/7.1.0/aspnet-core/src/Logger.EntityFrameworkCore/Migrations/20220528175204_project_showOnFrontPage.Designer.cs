...
namespace Logger.Migrations
{
    ...
    [Migration("20220528175204_project_showOnFrontPage")]
    partial class project_showOnFrontPage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logger.LogEntry.LogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Logger.Project.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Logger.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Logger.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Logger.LogEntry.LogEntry", b =>
                {
                    b.HasOne("Logger.Project.Project", "Project")
                        .WithMany()
